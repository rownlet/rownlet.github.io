!function(t, e) {
      ...
      , S = function() {
        ...
        return n.toggle = function() {
            ...
            if (i) {
                ...
                if (o) {
                    if ("radio" === o.type)
                        if (o.checked && this._element.classList.contains(E))
                            t = !1;
                        else {
                    ...
                    if (t) {
                        if (o.hasAttribute("disabled") || i.hasAttribute("disabled") || o.classList.contains("disabled") || i.classList.contains("disabled"))
                            return;
                        o.checked = !this._element.classList.contains(E),
                        e(o).trigger("change")
                    }
                    o.focus(),
                    n = !1
            ...
            n && this._element.setAttribute("aria-pressed", !this._element.classList.contains(E)),
            t && e(this._element).toggleClass(E)
        }
        ,
        n.dispose = function() {
            e.removeData(this._element, _),
            this._element = null
        }
        ,
        t._jQueryInterface = function(n) {
    ...
    var b = "carousel"
      ...
      , F = function() {
        ...
        n._slide = function(t, n) {
            var i, o, r, s = this, l = this._element.querySelector(H), c = this._getItemIndex(l), h = n || l && this._getItemByDirection(t, l), u = this._getItemIndex(h), f = Boolean(this._interval);
            if (r = t === k ? (i = "carousel-item-left",
            ...
            h && e(h).hasClass(j))
                ...
                if (e(this._element).hasClass("slide")) {
                    ...
                    this._config.interval = g ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
                    g) : this._config.defaultInterval || this._config.interval;
                    var _ = a.getTransitionDurationFromElement(l);
                    e(l).one(a.TRANSITION_END, function() {
                        e(h).removeClass(i + " " + o).addClass(j),
    ...
    var U = "collapse"
      ...
      , G = function() {
        ...
        n.show = function() {
            ...
            n && (i = e(n).not(this._selector).data(W)) && i._isTransitioning))) {
                ...
                !r.isDefaultPrevented()) {
                    ...
                    e(this._element).removeClass(Y).addClass(z),
                    this._element.style[s] = 0,
                    this._triggerArray.length && e(this._triggerArray).removeClass(X).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var l = "scroll" + (s[0].toUpperCase() + s.slice(1))
                      , c = a.getTransitionDurationFromElement(this._element);
                    e(this._element).one(a.TRANSITION_END, function() {
                        e(o._element).removeClass(z).addClass(Y).addClass(V),
                        o._element.style[s] = "",
        ...
        n.hide = function() {
            ...
            if (!this._isTransitioning && e(this._element).hasClass(V)) {
                ...
                !n.isDefaultPrevented()) {
                    ...
                    e(this._element).addClass(z).removeClass(Y).removeClass(V);
                    ...
                    e(this._element).one(a.TRANSITION_END, function() {
                        ...
                        e(t._element).removeClass(z).addClass(Y).trigger(B.HIDDEN)
                    }).emulateTransitionEnd(c)
                }
            }
        }
        ...
        ,
        n._getConfig = function(t) {
            return (t = r({}, K, t)).toggle = Boolean(t.toggle),
            a.typeCheckConfig(U, t, Q),
            t
        }
        ,
      ...
      , ft = function() {
                ...
                !o) {
                    ...
                    !s.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            var l = this._element;
                            "parent" === this._config.reference ? l = i : a.isElement(this._config.reference) && (l = this._config.reference,
        ...
        i.show = function() {
            if (!(this._element.disabled || e(this._element).hasClass(rt) || e(this._menu).hasClass(st))) {
                ...
                e(o).trigger(i),
                i.isDefaultPrevented() || (e(this._menu).toggleClass(st),
                e(o).toggleClass(st).trigger(e.Event(ot.SHOWN, n)))
            }
        }
        ,
        i.hide = function() {
            if (!this._element.disabled && !e(this._element).hasClass(rt) && e(this._menu).hasClass(st)) {
                ...
                e(o).trigger(i),
                i.isDefaultPrevented() || (e(this._menu).toggleClass(st),
                e(o).toggleClass(st).trigger(e.Event(ot.HIDDEN, n)))
            }
        }
        ,
        i.dispose = function() {
        ...
        i._getConfig = function(t) {
            ...
            a.typeCheckConfig(J, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        i._getPlacement = function() {
            var t = e(this._element.parentNode)
              , n = "bottom-start";
            return t.hasClass("dropup") ? (n = "top-start",
            e(this._menu).hasClass(at) && (n = "top-end")) : t.hasClass("dropright") ? n = "right-start" : t.hasClass("dropleft") ? n = "left-start" : e(this._menu).hasClass(at) && (n = "bottom-end"),
            n
        }
        ,
        ...
        t._dataApiKeydownHandler = function(n) {
            if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || e(n.target).closest(ct).length)) : it.test(n.which)) && (n.preventDefault(),
            n.stopPropagation(),
    ...
    var dt = "modal"
      ...
      , Dt = function() {
        ...
        n._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                e(document.body).removeClass(yt),
                t._resetAdjustments(),
                t._resetScrollbar(),
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), o = Object.keys(e), r = [].slice.call(i.body.querySelectorAll("*")), s = function(t, n) {
            ...
            a.forEach(function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === wt.indexOf(n) || Boolean(t.nodeValue.match(At) || t.nodeValue.match(Nt));
      ...
      , Yt = function() {
        ...
        i.toggle = function(t) {
            if (this._isEnabled)
                if (t) {
                    ...
                    if (e(this.getTipElement()).hasClass(Qt))
        ...
        i.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && e(s).addClass(Kt);
        ...
        i.setContent = function() {
            ...
            e(t).removeClass(Kt + " " + Qt)
        }
        ,
        i.setElementContent = function(t, n) {
            "object" != typeof n || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = Ot(n, this.config.whiteList, this.config.sanitizeFn)),
        ...
        i._enter = function(t, n) {
            ...
            e(n.getTipElement()).hasClass(Qt) || n._hoverState === qt ? n._hoverState = qt : (clearTimeout(n._timeout),
            n._hoverState = qt,
        ...
        i._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (e(t).removeClass(Kt),
    ...
    var oe = "scrollspy"
      ...
      , pe = function() {
        ...
        n._getConfig = function(t) {
            ...
            return a.typeCheckConfig(oe, t, ce),
            t
        }
        ,
        ...
        n._activate = function(t) {
            ...
            i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(ue),
            i.addClass(ue)) : (i.addClass(ue),
            i.parents(fe).prev(de + ", " + ge).addClass(ue),
            i.parents(fe).prev(".nav-item").children(de).addClass(ue)),
            e(this._scrollElement).trigger(he.ACTIVATE, {
                relatedTarget: t
            })
        }
        ,
    ...
    e(document).on(Ce.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Ie._jQueryInterface.call(e(this), "show")
    }),
    ...
    var De = "toast"
      ...
      , He = function() {
        ...
        n.hide = function(t) {
            var n = this;
            this._element.classList.contains(ke) && (e(this._element).trigger(Oe.HIDE),
        ...
        ,
        n._getConfig = function(t) {
            return t = r({}, je, e(this._element).data(), "object" == typeof t && t ? t : {}),
            a.typeCheckConfig(De, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        n._close = function() {
            ...
            if (this._element.classList.remove(ke),
            this._config.animation) {
                var i = a.getTransitionDurationFromElement(this._element);
                e(this._element).one(a.TRANSITION_END, n).emulateTransitionEnd(i)
            } else
